  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "Order ID", value: "order_id", groupable: false, sortable: false, },
        { text: "Total Harga", value: "total_price", groupable: false },
        { text: "Metode Bayar", value: "payment_method", groupable: false, sortable: false, },
        { text: "Waktu Pesan", value: "waktu_order", groupable: false, sortable: false, },
